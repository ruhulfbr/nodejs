...
router.post('/create-profile', isAuthenticated, createProfileMiddleWare('create-profile'), createProfileValidator, dashboardController.createProfilePost)
...
router.get('/edit-profile', isAuthenticated, dashboardController.editProfile)
